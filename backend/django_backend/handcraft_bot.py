...
PREDEFINED_RESPONSES = {
    ...
    "How can I check my reservations?": {
        "response": "You can view your reservations in your profile under the Reservations tab.",
        "redirect": "/myreservations",
    },
    "How can I check my favorites?": {
        "response": "You can find your favorited properties in the Favorites tab in your profile.",
        "redirect": "/myfavorites",
    },
    "How much time does it take to get a response to an inquiry?": {
        "response": "Our support team typically responds to inquiries within 24-48 hours. You can check everything in 'My Inquiries'.",
        "redirect": None,
    },
    "Where is your office located?": {
        "response": "Our office is located at 123 Main Street, Cityville. Check 'Contact Us' for directions.",
        "action": "open_contact_modal",
    },
    "How can I meet with you and visit your office?": {
        "response": "You can schedule a meeting through our 'Contact Us' page or email us at meetings@diplomaroad.pro.",
        "action": "open_contact_modal",
    },
    ...
    "How can I update my profile information?": {
        "response": "You can update your profile information inside the Profile page.",
